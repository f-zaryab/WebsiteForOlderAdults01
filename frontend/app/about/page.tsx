...
export const metadata: Metadata = {
  ...
  description: "Social Connections: Search what type of event you want. We believe in having a large group whenever we socialize. No one should be left behind",
};
